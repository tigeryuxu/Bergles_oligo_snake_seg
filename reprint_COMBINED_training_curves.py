...
folders_to_plot = [0, 2]
leg_to_plot = ['(80) HD no sps', '(82) HD sps only']
...
plt.ylabel('cIDice', fontsize=fontsize);  plt.yticks(fontsize=fontsize - 2); plt.ylim([0.3, 0.8])
...
plt.tight_layout()
plt.savefig(s_path + 'compare_SPS_cID_metric.png', dpi=300)
...
plt.ylabel('Haussdorf dist (px)', fontsize=fontsize); plt.yticks(fontsize=fontsize - 2);  plt.ylim([20, 40])
plt.xlabel('Iterations ($10^4$)', fontsize=fontsize);  plt.xticks(fontsize=fontsize - 2, rotation=rot);  #plt.xlim([0, 180000])
...
ax.spines['top'].set_visible(False)
plt.tight_layout()
plt.savefig(s_path + 'compare_SPS_HD_metric.png', dpi=300)
...
folders_to_plot = [3, 2, 9, 5]
leg_to_plot = ['(83) Cross Entropy', '(82) HD loss', '(93) HD - alpha = 1', '(86) cID loss']
...
plt.legend(leg_to_plot, loc='lower right', frameon=False, fontsize=fontsize-2)
plt.ylabel('cIDice', fontsize=fontsize);  plt.yticks(fontsize=fontsize - 2); plt.ylim([0.3, 0.8])
plt.xlabel('Iterations ($10^4$)', fontsize=fontsize); plt.xticks(fontsize=fontsize - 2, rotation=rot); plt.xlim([0, 15])

ax = plt.gca()
ax.spines['right'].set_visible(False)
ax.spines['top'].set_visible(False)
plt.tight_layout()
plt.savefig(s_path + 'compare_cID_metric_for_CE_HD_cID.png', dpi=300)
...
ax.spines['top'].set_visible(False)
plt.tight_layout()
plt.savefig(s_path + 'compare_HD_metric_for_CE_HD_cID.png', dpi=300)




""" Plot ONLY different alphas for HD """

""" (1) interesting graphs (HD vs. not HD, vs. cID) """
all_val_metrics['folder']
#folders_to_plot = [0, 1, 2, 3, 4, 5, 6]

folders_to_plot = [8, 9, 10]
leg_to_plot = ['(92) HD - alpha = 10', '(93) HD - alpha = 1', '(94) HD - alpha = 0.1']
...
ax.spines['top'].set_visible(False)
plt.tight_layout()
plt.savefig(s_path + 'compare_cID_metric_for_diff_ALPHAS.png', dpi=300)
...
ax.spines['top'].set_visible(False)
plt.tight_layout()
plt.savefig(s_path + 'compare_HD_metric_for_diff_ALPHAS.png', dpi=300)




""" Plot ALL output combined graphs """
